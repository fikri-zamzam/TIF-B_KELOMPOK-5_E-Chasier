...
public class View_barang extends javax.swing.JFrame {
    ...
    void tampilData(String nama){
        ...
        try{
            model.setRowCount(0);
            String sql = "SELECT barang.kode_barang, barang.nama_barang,"
                    + " barang.harga_beli, barang.harga_jual, barang.jumlah,"
                    + " barang.diskon, kategori.nama_kategori From barang"
                    + " INNER JOIN kategori ON"
                    + " barang.kode_kategori = kategori.kode_kategori";
//                    + " WHERE nama_barang LIKE '%"+nama+"%'";
            ResultSet rs = Database.ambildata("SELECT * FROM barang");
            while (rs.next()){
    ...
    private void initComponents() {
        ...
        tblbarang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Barang", "Nama Barang", "Harga Beli", "Harga Jual", "Stok", "Diskon", "Kategori"
            }
        ));
